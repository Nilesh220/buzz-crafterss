        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 xl:gap-20 items-start">
          ...
          <div className="lg:col-span-7">
            <h2 className="font-satoshi font-black text-[#121113] tracking-tight text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-[1.05]">
              ...
              <span className="block text-black/40">more empty noise.</span>
              <span className="block mt-2">They need attention</span>
              <span className="block text-[#ff3366] bg-[#fff1f4] border border-[#ff3366]/20 px-3 py-1 w-fit rounded-xl shadow-sm mt-2">
                that actually moves.
              </span>
            </h2>

            <p className="font-inter text-neutral-600 text-base sm:text-lg md:text-xl leading-relaxed mt-8 max-w-2xl">
          ...
          <div className="lg:col-span-5 flex flex-col gap-3.5 w-full">
            <span className="font-mono text-xs text-neutral-500 uppercase tracking-widest mb-1">
              FIVE CORE FORCES
            </span>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3.5">
                    <span
                      className={`font-mono text-xs font-bold ${
                        activeWord === idx ? "text-[#ff3366]" : "text-neutral-400"
                      }`}
                    >
                      0{idx + 1}
                    </span>
                  ...
                  <Sparkles
                    ...
                    className={`transition-colors ${
                      activeWord === idx ? "text-[#ff3366]" : "text-neutral-300"
                    }`}
                  />
                </div>
                <p
                  className={`font-inter text-xs sm:text-sm mt-2 transition-colors ${
                    activeWord === idx ? "text-neutral-300" : "text-neutral-600"
                  }`}
                >
                  {item.desc}
                </p>
