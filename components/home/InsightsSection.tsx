        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 w-full">
          {insights.slice(0, 4).map((article) => (
            ...
            >
              ...
              {/* Title */}
              <h3 className="font-satoshi font-bold text-xl sm:text-2xl md:text-3xl text-[#121113] mb-3 tracking-tight leading-snug group-hover:text-[#ff3366] transition-colors">
                {article.title}
              </h3>

              {/* Excerpt */}
              <p className="font-inter text-xs sm:text-sm text-neutral-600 leading-relaxed line-clamp-2 mb-6">
                {article.excerpt}
              </p>
