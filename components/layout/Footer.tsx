...
export default function Footer() {
  return (
    <footer className="bg-[#0a0a0a] text-[#f5f5f0] border-t border-[#222] w-full">
      <div className="site-container py-14 sm:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-14 mb-12 w-full">
          ...
          <div className="lg:col-span-2 flex flex-col gap-2.5">
            <span className="font-mono text-xs uppercase tracking-widest text-[#c8f135] font-semibold mb-1">
              EXPLORE
            </span>
            {footerLinks.map((link) => (
              <Link
                key={link.label}
                href={link.href}
                className="font-inter text-xs sm:text-sm text-neutral-400 hover:text-white transition-colors"
              >
                {link.label}
              </Link>
            ))}
          ...
          <div className="lg:col-span-2 flex flex-col gap-2.5">
            ...
            <a
              ...
              className="font-inter text-xs sm:text-sm text-neutral-400 hover:text-white transition-colors flex items-center gap-1"
            >
              <span>Instagram</span>
          ...
          <div className="lg:col-span-3 flex flex-col gap-3">
            ...
            <a
              ...
              className="font-inter text-sm font-semibold text-white hover:text-[#c8f135] transition-colors"
            >
              hello@buzzcrafterss.com
            </a>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 font-inter text-xs font-bold tracking-wider uppercase px-5 py-3 rounded-xl bg-white text-black hover:bg-[#c8f135] transition-all w-fit mt-1 shadow-md"
              data-cursor="explore"
            >
        ...
        {/* Bottom Bar */}
        <div className="border-t border-[#222] pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-neutral-500 font-inter">
